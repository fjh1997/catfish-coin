...
Moefish Coin / 猫鱼币是 DERO HE 的修改版分叉，仅用于学习、娱乐、技术研究和个人评估。
...
- Moefish 专用测试/公网 network ID、端口和 seed 节点配置。
- 降低注册交易 PoW 阈值，方便学习测试。
- 轻量 Windows 桌面客户端。
- 钱包、余额、转账、留言、区块浏览器和合约界面。
...
Moefish Coin is a modified fork of DERO HE for learning, entertainment, technical research, and personal evaluation.
...
- Moefish-specific test/public network ID, ports, and seed node configuration.
